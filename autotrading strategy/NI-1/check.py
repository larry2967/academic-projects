...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr  3 20:00:24 2018
...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr  3 19:29:11 2018
...
def Trading_Sig(filename, tf):
    ...
    for i in range(tf, ns):
        if aroon1[i] in range (-100,-86):
            #print("this works1", aroon1[i])
            sig[i] = -1
            #print(sig[i])
        elif aroon1[i] in range (-5, 0):
            #print("this works2", aroon1[i])
            sig[i] = +1
            #print(sig[i])
        elif aroon1[i] in range (86, 100):
            #print("this works3", aroon1[i])
            sig[i] = +1
        elif aroon1[i] in range (0,5):
